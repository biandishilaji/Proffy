...
```bash
# Clone Repository
$ git clone https://github.com/biandishilaji/Proffy.git
```
### 📦 Run API
...
Feel free to **file a new issue** with a respective title and description on the the [Proffy](https://github.com/biandishilaji/Proffy/issues) repository. If you already found a solution to your problem, **i would love to review your pull request**!
...
* Check the [issues page](https://github.com/biandishilaji/proffy/issues) for already opened issues (or maybe even closed ones) that might already address your question/bug/feature request.
